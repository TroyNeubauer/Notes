...
import de.tomgrill.gdxdialogs.core.dialogs.GDXButtonDialog  bh`;
...
public class MainScreen implements Screen {
    ...
    public MainScreen(final Notes game) {
        this.game = game;
        ...
        container.setBounds(5 * Gdx.graphics.getWidth()/6, 0, Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
